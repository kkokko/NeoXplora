...
initialization
  ...
  TGuessObject.RegisterToken(TGuessObject.Tok_MatchSentenceA, 'guesses1');
  TGuessObject.RegisterToken(TGuessObject.Tok_MatchSentenceB, 'guesses2');
  TGuessObject.RegisterToken(TGuessObject.Tok_MatchSentenceC, 'guesses3');
  TGuessObject.RegisterToken(TGuessObject.Tok_MatchSentenceD, 'guesses4');
  TGuessObject.RegisterToken(TGuessObject.Tok_RepGuessA, 'repguess1');
  TGuessObject.RegisterToken(TGuessObject.Tok_RepGuessB, 'repguess2');
  TGuessObject.RegisterToken(TGuessObject.Tok_RepGuessC, 'repguess3');
  TGuessObject.RegisterToken(TGuessObject.Tok_RepGuessD, 'repguess4');
  TGuessObject.RegisterToken(TGuessObject.Tok_CRepGuessA, 'crepguess1');
  TGuessObject.RegisterToken(TGuessObject.Tok_SRepGuessA, 'srepguess1');
  TGuessObject.RegisterToken(TGuessObject.Tok_SRepGuessB, 'srepguess2');
  TGuessObject.RegisterToken(TGuessObject.Tok_SRepGuessC, 'srepguess3');
  TGuessObject.RegisterToken(TGuessObject.Tok_SRepGuessD, 'srepguess4');

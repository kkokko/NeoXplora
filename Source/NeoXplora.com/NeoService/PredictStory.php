...
if(!isset($_POST['storyID'])) exit;

$storyID = $_POST['storyID'];

require_once "App/Global.php";
$TheGuesses = $server->GuessRepsForStoryId((int) $storyID);
...
$repguessesData = '<span  guessid="' . $TheGuesses->GetProperty('GuessIdD') .'" class="guess" id="4'. $sentencesData .'r" style="color;color:#999999;">' . $TheGuesses->GetProperty('RepGuessD') . '</span><br />
<span  guessid="' . $TheGuesses->GetProperty('GuessIdC') .'" class="guess"  id="3'. $sentencesData .'r" style="color;color:#999999;">' . $TheGuesses->GetProperty('RepGuessC') . '</span><br />
<span  guessid="' . $TheGuesses->GetProperty('GuessIdA') .'" class="guess"  id="1'. $sentencesData .'r" style="color;color:#999999;">'. $TheGuesses->GetProperty('RepGuessA')  . '</span><br />
<span  guessid="' . $TheGuesses->GetProperty('GuessIdB') .'" class="guess"  id="2'. $sentencesData .'r" style="color;color:#999999;">'. $TheGuesses->GetProperty('RepGuessB')  . '</span><br />';

$srepguessData = '<span  guessid="' . $TheGuesses->GetProperty('GuessIdD') .'" id="4'. $sentencesData .'s" class="guess"  style="color;color:#999999;">' . $TheGuesses->GetProperty('SRepGuessD') . '</span><br />
<span  guessid="' . $TheGuesses->GetProperty('GuessIdC') .'" class="guess"  id="3'. $sentencesData .'s" style="color;color:#999999;">' . $TheGuesses->GetProperty('SRepGuessC') . '</span><br />
<span  guessid="' . $TheGuesses->GetProperty('GuessIdA') .'" class="guess"  id="1'. $sentencesData .'s" style="color;color:#999999;">'. $TheGuesses->GetProperty('SRepGuessA')  . '</span><br />
<span  guessid="' . $TheGuesses->GetProperty('GuessIdB') .'" class="guess"  id="2'. $sentencesData .'s" style="color;color:#999999;">'. $TheGuesses->GetProperty('SRepGuessB')  . '</span><br />';
                  
$crepguessData = '<span class="guess" style="color;color:#999999;">' . $TheGuesses->GetProperty('SRepGuessA') . '</span><br />';

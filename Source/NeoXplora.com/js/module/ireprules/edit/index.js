var MIRepRuleEditIndex_Implementation = {
  ...
  methods: {
    ...
    init: function() {
  	...
  	bindGUI: function() {
      this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.PostRuleName, NeoX.Modules.IRepRuleEditIndex.bindPostRuleNameButton);
  		this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.AddCondition, NeoX.Modules.IRepRuleEditIndex.bindAddConditionButton);
      this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.AddValue, NeoX.Modules.IRepRuleEditIndex.bindAddValueButton);
      this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.SaveValue, NeoX.Modules.IRepRuleEditIndex.bindSaveValuesButton);
      this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.SaveConditions, NeoX.Modules.IRepRuleEditIndex.bindSaveConditionsButton);
  	...
  	bindConditionsGUI: function() {
  		this.hookEvent("change", NeoX.Modules.IRepRuleEditIndex.getConfig().Controls.CTSelector, NeoX.Modules.IRepRuleEditIndex.onConjunctionTypeChange);
  		this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.MoveUpCondition, NeoX.Modules.IRepRuleEditIndex.onConditionMoveUp);
  		this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.MoveDownCondtion, NeoX.Modules.IRepRuleEditIndex.onConditionMoveDown);
  		this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.GroupCondtion, NeoX.Modules.IRepRuleEditIndex.onConditionsGroup);
  		this.hookEvent("click", NeoX.Modules.IRepRuleEditIndex.getConfig().Buttons.DeleteCondition, NeoX.Modules.IRepRuleEditIndex.onConditionDelete);
  	},

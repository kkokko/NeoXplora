...
type
  ...
  THyperNode = record
    //  make sure we use New, Dispose for this
    Brother: PHyperNode;
    Parent: PHyperNode;
  end;
...
begin
  if ((AWord1 = 'friend') and (AWord2 = 'collegue')) or
    ((AWord2 = 'friend') and (AWord1 = 'collegue')) then
  begin
    Result := 0;
  end;
  if ((AWord1 = 'friend') and (AWord2 = 'bird')) or
    ((AWord2 = 'friend') and (AWord1 = 'bird')) then
  begin
    Result := 0;
  end;
  Result := 0;

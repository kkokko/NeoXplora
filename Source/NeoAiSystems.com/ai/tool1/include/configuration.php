...
$configuration['db']	= 'db179668_ai'; 		//	database name
$configuration['host']	= '127.0.0.1';	//	database host
$configuration['user']	= 'db179668_aitool1';		//	database user
$configuration['pass']	= 'ehsanSA146';		//	database password
...
if (! mysql_select_db($configuration['db']) ) {
    die ('Can\'t use db ai : ' . mysql_error());
}

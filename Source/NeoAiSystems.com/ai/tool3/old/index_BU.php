<?php
	...
	if(isset($_POST['rows']) && !empty($_POST['rows'])){
		...
		for($z=0; $z<$quantity; $z++){
			...
			$query = "UPDATE sentenceTBL SET sentence='".$_POST['sentenceID'.$idSentences[$z]]."', representation='".$_POST['representationID'.$idSentences[$z]]."', context_rep='".$_POST['contextrepID'.$idSentences[$z]]."', CRcomment='".$_POST['CRcommentID'.$idSentences[$z]]."',POS='".$_POST['POSID'.$idSentences[$z]]."'WHERE sentenceID=".$idSentences[$z];

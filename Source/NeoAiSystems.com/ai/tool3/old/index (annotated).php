<?php
	...
	if(isset($_POST['rows']) && !empty($_POST['rows'])){
		...
		for($z=0; $z<$quantity; $z++){
			...
			$query = "UPDATE sentenceTBL SET sentence='".$_POST['sentenceID'.$idSentences[$z]]."', representation='".$_POST['representationID'.$idSentences[$z]]."' WHERE sentenceID=".$idSentences[$z];
...
<?php
	...
	// 17. NO CATEGORY SELECTED IN PREVIOUS SCREEN	
		...
		// 19. Print stories REMEMBERING LAST ONE SELECTED
	...
	<div id="tabs-left">
        ...
        <div id="tabs-1">
        	<?php
				...
				//21. DISPLAY CURRENTLY SELECTED STORY	
				...
				//22. OTHERWISE DISPLAY 1ST STORY. Q. THIS CODE IS IDENTICAL I THINK? WE COULD HAVE JUST SET CATSTORY = 1 IF NOT SET AND THEN LIST THE CODE ONLY ONCE?	
					$query = "select * from sentenceTBL where storyID=1";

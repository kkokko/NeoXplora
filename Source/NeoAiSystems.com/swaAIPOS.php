...
function smith_waterman ($str1, $str2, &$html)
{
		...
		$posHTML1 = posHTMLfn($str1);
		$posHTML2= posHTMLfn($str2);
        ...
        for ($i = 1; $i <= $m; $i++)
        {
                ...
                {              
                        ...
                        $s1 = clean_token($pos1[$i-1]);
                        $s2 = clean_token($pos2[$j-1]);
...
//                print_r($Y);
                ...
                $s1 = clean_token($pos1[$i]);
                $s2 = clean_token($pos2[$j]);

<?php 
require_once 'SentenceSplitter.php';
class PosTagger {
        private $dict; 
        ...
        private function getTextMaches($text){
          //preg_match_all("/[\w\d\.]+/", $text, $matches);
          $TheSentenceSplitWords = new SentenceSplitter();          
          return $TheSentenceSplitWords->SentenceSplitWords($text);          
        }
        
        public function tag($text) {                
                $matches = $this->getTextMaches($text);
                $nouns = array('NN', 'NNS');

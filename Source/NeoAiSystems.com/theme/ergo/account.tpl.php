...
<div class="container">
  <div id="page" class="row grid_24">
    <h1><?php echo _UA_TITLE1;?>     <?php if($user->logged_in){?>
          <span style="float:right;font-size: 24px;text-decoration: underline;"><a href="logout.php"><?php echo _N_LOGOUT;?></a></span> <?php } ?></h1>
      ...
      <form action="#" method="post" id="admin_form" name="admin_form">
        ...
        <table class="display">
          ...
          <tr>
            ...
            <td><div style="position:relative; display:none;" > <span style="position:absolute;right:0;top:-70px">
                <?php if($row['fbid']):?>
